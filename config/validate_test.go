...
func TestValidate(t *testing.T) {
	tests := []struct {
		...
		{"negative audit_max_size_mb", Config{AuditMaxSizeMB: -1}, "audit_max_size_mb"},
		{"negative audit_max_files", Config{AuditMaxFiles: -2}, "audit_max_files"},
		{"invalid audit_webhook_url", Config{AuditWebhookURL: "ftp://x"}, "audit_webhook_url"},
